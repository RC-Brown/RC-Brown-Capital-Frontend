...
function transformBackendToFormData(backendData: any): ProjectUploadInput {
  return {
    ...
    years_of_active_operation: backendData.years_of_active_operation || "",
    ...
    key_deal_points: backendData.key_deal_points || {
      ...
      total_capital_required: backendData.total_capital_required || "0",
      total_debt_allocation: backendData.total_debt_allocation_percent?.toString() || "0",
    ...
    investment_hold_period: backendData.investment_hold_period?.toString() || "",
    ...
    targeted_distribution_start_date_debt: backendData.targeted_distribution_start_date_debt || "",
    targeted_distribution_start_date_equity: backendData.targeted_distribution_start_date_equity || "",
